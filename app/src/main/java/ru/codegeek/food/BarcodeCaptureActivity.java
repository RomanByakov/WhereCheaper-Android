...
import ru.codegeek.food.camera.CameraSource;
import ru.codegeek.food.camera.CameraSourcePreview;
import ru.codegeek.food.camera.GraphicOverlay;
    ...
    public void onCreate(Bundle icicle) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mCameraSource.setFlashMode(!flashOn ? Camera.Parameters.FLASH_MODE_TORCH : Camera.Parameters.FLASH_MODE_OFF);
                if(flashOn) {
                    fab.setImageResource(R.drawable.reddot_flash);
                } else {
                    fab.setImageResource(R.drawable.reddot_noflash);
                }
                flashOn = !flashOn;
...
//        Snackbar.make(mGraphicOverlay, "Навердите на штрихкод",
